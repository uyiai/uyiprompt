...
当前版本 **0.4.0**：https://github.com/uyiai/uyiprompt/releases/tag/v0.4.0

## 要求

- macOS 15+
- 自己的 API Key（DeepSeek / OpenAI / Kimi / 自定义兼容接口），或本机运行的 Ollama / LM Studio（无需 Key）
...
4. 浮层里「替换」或「复制」，也可以用「更短 / 更正式」或自由指令再改一轮。
5. 键盘党：**⌃⇧Space** 弹出风格面板（按 1-9 选风格），**⌃⇧E** 改写、**⌃⇧T** 翻译、**⌃⇧O** 截图取词（系统 Vision 离线识别）、**⌘⇧U** 打开草稿面板。
