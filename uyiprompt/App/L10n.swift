...
enum L10n {
    ...
    private static let zh: [String: String] = [
        ...
        "nav.shortcuts": "快捷键",
        "nav.history": "历史",
        "history.empty": "还没有记录。改写或翻译成功后会出现在这里。",
        "history.clear": "清空",
        "history.copyResult": "复制结果",
        ...
        "menu.close": "关闭",
        "menu.minimize": "最小化",
        "recovery.openPanel": "打开面板",
        "recovery.continueInPanel": "在面板里继续",
        "recovery.copyOriginal": "复制原文",
        ...
        "selection.actionBar.caption": "松开鼠标后，在选区下方出现「改写 / 翻译」，避开应用自带的复制菜单。关掉后只能把文字粘贴到面板里处理。",
        "history.record": "记录最近的改写和翻译",
        "history.record.caption": "关掉后不再把原文和结果写入本机的历史文件。",
        "appDefaults.actionBar": "动作条",
        "shortcuts.enhance": "改写选中文字",
        "shortcuts.translate": "翻译选中文字",
        "section.desktop": "桌面",
        ...
        "howto.action": "改写或翻译",
        "howto.replace": "点「替换」",
        "shortcuts.help": "在微信、备忘录里选中文字，选区下方会出现改写 / 翻译，不挡住应用自带的复制菜单。点按钮后，在浮层里替换或复制。",
        ...
        "error.timeout": "请求超时了，网络或服务较慢，请重试",
        "error.offline": "当前没有网络连接，请检查网络后重试",
        "error.dns": "找不到服务器，请检查接口地址是否正确",
        "error.tls": "建立安全连接失败，请检查接口地址或网络环境",
        "error.truncated": "结果可能被截断了：文字较长，模型输出达到了上限",
        ...
        "error.selectOther": "请先在别的软件里选中文字，或打开面板贴进去。",
        "error.noSelection": "没读到选中的文字。再选一次，或打开面板把文字贴进去。",
    ]
    ...
    private static let en: [String: String] = [
        ...
        "nav.history": "History",
        "history.empty": "Nothing yet. Successful rewrites and translations show up here.",
        "history.clear": "Clear",
        "history.copyResult": "Copy result",
        "history.copyOriginal": "Copy original",
        "history.delete": "Delete",
        "history.reuse": "Send to panel",
        "menu.recent": "Recent",
        "menu.noRecent": "No recent items",
        ...
        "recovery.openPanel": "Open panel",
        "recovery.continueInPanel": "Continue in panel",
        "recovery.copyOriginal": "Copy original",
        ...
        "selection.actionBar.caption": "After you release the mouse, Rewrite / Translate appear below the selection so they do not cover the app's Copy menu. Turn this off to use the panel only.",
        "history.record": "Keep recent rewrites and translations",
        "history.record.caption": "When off, originals and results are no longer written to the local history file.",
        "appDefaults.actionBar": "Action bar",
        "shortcuts.enhance": "Rewrite selection",
        "shortcuts.translate": "Translate selection",
        ...
        "shortcuts.help": "Select text in WeChat, Notes, or a browser. Rewrite / Translate appear below the selection so they do not cover Copy. Then replace or copy.",
        ...
        "onboard.step2.caption": "The chips appear below the selection when you release the mouse, clear of the host Copy menu.",
        ...
        "error.offline": "You appear to be offline. Check the connection and try again",
        "error.dns": "Server not found. Check the base URL",
        "error.tls": "Secure connection failed. Check the base URL or your network",
        "error.truncated": "The result may be truncated: the model hit its output limit",
        ...
        "error.selectOther": "Select text in another app first, or open the panel and paste.",
        "error.noSelection": "Couldn’t read the selection. Select it again, or open the panel and paste.",
    ]
}
